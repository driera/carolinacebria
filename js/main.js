...
},{"./flickity":8,"fizzy-ui-utils":3,"unidragger":24}],8:[function(require,module,exports){
// Flickity main
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":8,"fizzy-ui-utils":3,"tap-listener":22}],12:[function(require,module,exports){
// player & autoPlay
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":8,"fizzy-ui-utils":3,"tap-listener":22}],14:[function(require,module,exports){
// slide
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"lazysizes":18}],20:[function(require,module,exports){
/*! lazysizes - v4.0.0-rc3 */
...
},{"lazysizes":18}],21:[function(require,module,exports){
/*!
...
},{"unipointer":25}],23:[function(require,module,exports){
/*!
 * Unipointer v2.1.0
...
},{"ev-emitter":2}],26:[function(require,module,exports){
'use strict';
...
var _homeGallery = require('./modules/home-gallery');

var _homeGallery2 = _interopRequireDefault(_homeGallery);
...
var homeGallery = new _homeGallery2.default();

},{"./modules/home-gallery":27,"./modules/navbar":28,"./modules/plugins":29,"lazysizes":18,"lazysizes/plugins/bgset/ls.bgset.min":19,"lazysizes/plugins/parent-fit/ls.parent-fit.min":20}],27:[function(require,module,exports){
'use strict';
...
var HomeGallery = function () {
    function HomeGallery() {
        ...
        this.gallery = '.home-projects--list';
        this.addEvents();
    }

    _createClass(HomeGallery, [{
        key: 'addEvents',
        value: function addEvents() {
            $(this.gallery).flickity({
                contain: true,
                wrapAround: true,
                cellAlign: 'center',
                pageDots: false
...
exports.default = HomeGallery;

},{"flickity":9,"jquery":17,"jquery-bridget":16}],28:[function(require,module,exports){
'use strict';
...
var navbar = function () {
    ...
    _createClass(navbar, [{
        ...
        value: function addEvents() {
            ...
            (0, _jquery2.default)(document).on('click', self.navbarOpen, function () {
                (0, _jquery2.default)(self.navbar).addClass(self.activeClass);
            });

            (0, _jquery2.default)(document).on('click', self.navbarClose, function () {
                (0, _jquery2.default)(self.navbar).removeClass(self.activeClass);
            });
        }
    }]);
